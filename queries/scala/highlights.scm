...
; Edited from: https://github.com/tree-sitter/tree-sitter-scala/blob/master/queries/scala/highlights.scm
...
;;(case_clause pattern: (case_class_pattern type: (type_identifier) @constructor ))
...
(field_expression value: (identifier) @object.call
 (#match? @object.call "^[A-Z]"))
...
(interpolated_string (interpolation) @property)

;; My custom rules
(
  (operator_identifier) @error 
  (#match? @error "^\\?\\?\\?$")
)
